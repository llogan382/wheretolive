...
export const MostPopulated = (jsonResponse) => {
  ...
  // console.log(asArray[2]);
    ...
    return Number(b[1])-Number(a[1])
                ...
                const result = topThirdSorted.slice().sort(function(a, b) { return Number(b[2]) - Number(a[2])});
  ...
  return(
        <div>
          ...
          <ol>
{Object.values(result).slice(1,4).map(item =>
